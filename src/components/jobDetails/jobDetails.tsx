...
import { MapPin, Calendar, Briefcase, CheckCircle2, Clock } from "lucide-react"
      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="p-4">
            <div className="flex gap-3 items-start">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">{job.postalCode}</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-4">
            <div className="flex gap-3 items-start">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground capitalize">{job.rateType}</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-4">
            <div className="flex gap-3 items-start">
              ...
              <div>
                ...
                <p className="font-semibold text-foreground">{formatExperience(job.experience)}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {job.skills.map((skill) => (
                  <div key={skill} className="flex items-center gap-2 p-2 bg-gray-200 rounded-lg">
          ...
          <div className="space-y-4">
            <div className={`p-6 ${isDeadlineSoon ? "border-destructive" : ""}`}>
              <div className="flex items-center gap-2 mb-4">
                <Clock className="w-5 h-5 text-primary" />
                <h3 className="font-semibold text-foreground">Application Deadline</h3>
              </div>
              <p className="text-lg font-bold text-foreground mb-2">{formatDate(job.deadline)}</p>
            </div>
            ...
            <div className="p-6">
              ...
              <div className="space-y-3 text-sm">
                <div>
                  ...
                  <p className="font-mono text-xs text-foreground truncate">{job._id}</p>
                </div>
                <div>
