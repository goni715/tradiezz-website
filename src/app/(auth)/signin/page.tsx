...
const categories = {
  Technology: ["Web Development", "Mobile Development", "Data Science", "AI/ML", "DevOps"],
  Design: ["UI/UX Design", "Graphic Design", "Product Design", "Brand Design", "Motion Graphics"],
  Marketing: ["Digital Marketing", "Content Marketing", "SEO/SEM", "Social Media", "Email Marketing"],
  Business: ["Consulting", "Project Management", "Sales", "Operations", "Strategy"],
}
    ...
    <div className="min-h-screen bg-background py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Join our professional community</p>
        </div>
        ...
        <div className="bg-card rounded-lg shadow-lg p-8">
            ...
            <div className="space-y-6">
              ...
              {formData.category && (
                <div>
                  ...
                  {errors.subCategory && <p className="text-destructive text-sm mt-1">{errors.subCategory}</p>}
                </div>
              )}
            </div>
          )}
              ...
              <div>
                ...
                <div className="flex gap-2 mb-3">
                  <input
                    ...
                    className="flex-1 px-4 py-3 bg-input border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-ring focus:border-primary transition-colors"
                    onKeyPress={(e) => {
                      if (e.key === "Enter") {
                        e.preventDefault()
          ...
          <div className="flex justify-between mt-8">
            <button
              ...
              className="px-6 py-3 bg-secondary text-secondary-foreground rounded-lg hover:bg-secondary/90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
              Back
            </button>
            ...
            {currentStep < totalSteps ? (
              ...
              <button
                ...
                className="px-6 py-3 bg-blue-500 text-white hover:bg-blue-600 rounded-lg hover:bg-accent/90 transition-colors"
              >
                Submit
              </button>
            )}
